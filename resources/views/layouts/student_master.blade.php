                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ auth()->guard('student')->user()->profile_picture ? auth()->guard('student')->user()->profile_picture : env('DICEBEAR_LINK'). auth()->guard('student')->user()->first_name }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="{{ route('admin.profile') }}">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">{{auth()->guard('student')->user()->first_name." ".auth()->guard('student')->user()->last_name }}</span>

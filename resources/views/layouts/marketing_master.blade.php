      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item {{ Route::is('marketing.dashboard') ? 'active':'' }}">
              <a href="{{ route('marketing.dashboard') }}" class="menu-link">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ auth()->guard('marketing')->user()->profile_picture ? auth()->guard('marketing')->user()->profile_picture : env('DICEBEAR_LINK'). auth()->guard('marketing')->user()->first_name }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                      <a class="dropdown-item" href="{{ route('marketing.profile') }}">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">{{auth()->guard('marketing')->user()->first_name." ".auth()->guard('marketing')->user()->last_name }}</span>
                            <small class="text-muted">Marketer</small>
                          </div>
                        </div>
                      </a>
                    </li>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a href="{{ route('marketing.logout') }}" class="btn btn-primary">Logout</a>
            </div>
          </div>
        </div>
      </div>

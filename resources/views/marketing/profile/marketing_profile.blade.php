@extends('layouts.marketing_master')
@section('page_title', 'Marketing - Profile')
@section('marketing_main_content')
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="d-flex align-items-start align-items-sm-center gap-4">
                    <img src="{{ auth()->guard('marketing')->user()->profile_picture ? auth()->user()->profile_picture : env('DICEBEAR_LINK'). auth()->guard('marketing')->user()->first_name }}"
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="firstName" name="firstName"
                                value="{{auth()->guard('marketing')->user()->first_name }}" autofocus="">
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Last Name</label>
                            <input class="form-control" type="text" name="lastName" id="lastName" value="{{auth()->guard('marketing')->user()->last_name }}">
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="email" class="form-label">E-mail</label>
                            <input class="form-control" type="text" id="email" name="email" value="{{auth()->guard('marketing')->user()->email }}"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" id="phoneNumber" name="phoneNumber" class="form-control"
                                    placeholder="202 555 0111" value="{{auth()->guard('marketing')->user()->phone }}">
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
